  ...
  return (
    <div className="container py-10">
      <div className="dotted-background relative overflow-hidden rounded-3xl bg-teal-700 px-4 py-18">
        <div className="absolute bottom-full left-1/2 aspect-square w-10/12 -translate-x-1/2 translate-y-1/3 rounded-full bg-teal-700 shadow-teal-700 blur-xl"></div>
