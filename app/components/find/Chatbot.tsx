...
export function Chatbot() {
  ...
  return (
    <div className="mb-10 w-full rounded-xl border border-gray-200 p-4 px-5 text-sm outline-6 outline-gray-200/50 transition-all has-focus:border-teal-100 has-focus:outline-teal-50">
      <textarea
        name=""
        id=""
